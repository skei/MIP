...
//------------------------------
  ...
  sa_tyr_editor(MIP_EditorListener* AListener, MIP_ClapPlugin* APlugin, uint32_t AWidth, uint32_t AHeight, MIP_ParameterArray* AParameters, const clap_plugin_descriptor_t* descriptor)
  : MIP_Editor(AListener,AWidth,AHeight,AParameters) {
    ...
    MIP_SAHeaderWidget* header = new MIP_SAHeaderWidget(MIP_DRect(0,0,SA_TYR_EDITOR_WIDTH,HEADER_HEIGHT),descriptor);
...
//    window->appendChildWidget(MEditorPanel);
    ...
    window->setRootWidget(MEditorPanel);
