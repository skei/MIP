...
//------------------------------
  ...
  sa_tyr_editor(MIP_EditorListener* AListener, uint32_t AWidth, uint32_t AHeight, MIP_ParameterArray* AParameters, const clap_plugin_descriptor_t* descriptor)
  : MIP_Editor(AListener,AWidth,AHeight,AParameters) {
    ...
    MIP_SAHeaderWidget* header = new MIP_SAHeaderWidget(MIP_DRect(0,0,SA_TYR_EDITOR_WIDTH,HH),descriptor);
...
// ----- osc1
      ...
      sa_tyr_SectionPanelWidget* osc1_panel = new sa_tyr_SectionPanelWidget(MIP_DRect(10,HH+10,260,300), "OSC1", 20 );
      MEditorPanel->appendChildWidget(osc1_panel);

        // type

        sa_tyr_SelectorWidget* osc1_type_selector = new sa_tyr_SelectorWidget( MIP_DRect(10+10,HH+30+10,240,20), "Osc Type", osc_type_menu );
        osc1_panel->appendChildWidget(osc1_type_selector);
        connect(osc1_type_selector, AParameters->getItem(PAR_OSC1_TYPE) );

        // shape

        sa_tyr_BigKnobWidget* osc1_shape_knob = new sa_tyr_BigKnobWidget( MIP_DRect(10+10,HH+60,50,82),"Shape");
        ...
        sa_tyr_BigKnobWidget* osc1_width_knob = new sa_tyr_BigKnobWidget( MIP_DRect(70+10,HH+60,50,82),"Width", 0.0, true);
        ...
        sa_tyr_DragValueWidget* osc1_cent_slider = new sa_tyr_DragValueWidget( MIP_DRect(178+10,HH+150,72,20), "Cent", 0.0, true, 0.0, 0.1 );
        osc1_panel->appendChildWidget(osc1_cent_slider);
        connect(osc1_cent_slider,AParameters->getItem(PAR_OSC1_CENT));

        // inputs

        sa_tyr_SmallKnobWidget* osc1_in_o1 = new sa_tyr_SmallKnobWidget( MIP_DRect(10+10,HH+180,27,45),"O1");
        osc1_panel->appendChildWidget(osc1_in_o1);
        connect(osc1_in_o1,AParameters->getItem(PAR_OSC1_IN_O1));

        sa_tyr_SmallKnobWidget* osc1_in_o2 = new sa_tyr_SmallKnobWidget( MIP_DRect(40+10,HH+180,27,45),"O2");
        osc1_panel->appendChildWidget(osc1_in_o2);
        connect(osc1_in_o2,AParameters->getItem(PAR_OSC1_IN_O2));

        sa_tyr_SmallKnobWidget* osc1_in_r1 = new sa_tyr_SmallKnobWidget( MIP_DRect(70+10,HH+180,27,45),"R1");
        osc1_panel->appendChildWidget(osc1_in_r1);
        connect(osc1_in_r1,AParameters->getItem(PAR_OSC1_IN_R1));

        sa_tyr_SmallKnobWidget* osc1_in_r2 = new sa_tyr_SmallKnobWidget( MIP_DRect(100+10,HH+180,27,45),"R2");
        osc1_panel->appendChildWidget(osc1_in_r2);
        connect(osc1_in_r2,AParameters->getItem(PAR_OSC1_IN_R2));

        sa_tyr_SmallKnobWidget* osc1_in_n = new sa_tyr_SmallKnobWidget( MIP_DRect(130+10,HH+180,27,45),"N");
        osc1_panel->appendChildWidget(osc1_in_n);
        connect(osc1_in_n,AParameters->getItem(PAR_OSC1_IN_N));

        sa_tyr_SmallKnobWidget* osc1_in_a = new sa_tyr_SmallKnobWidget( MIP_DRect(160+10,HH+180,27,45),"A");
        ...
        sa_tyr_SelectorWidget* osc1_phase_shaper_selector = new sa_tyr_SelectorWidget( MIP_DRect(10+10,HH+240,115,20),"Phase Shp",phase_shaper_type_menu );
        ...
        sa_tyr_SelectorWidget* osc1_wave_shaper_selector = new sa_tyr_SelectorWidget( MIP_DRect(10+10,HH+270,115,20),"Wave Shp",wave_shaper_type_menu );
...
// ----- res1 -----
      ...
      sa_tyr_SectionPanelWidget* res1_panel = new sa_tyr_SectionPanelWidget(MIP_DRect(10,HH+320,260,260), "RES1", 20 );
      MEditorPanel->appendChildWidget(res1_panel);

        // type

        sa_tyr_SelectorWidget* res1_type_selector = new sa_tyr_SelectorWidget( MIP_DRect(10+10,HH+310+30+10,240,20),"Res Type",res_type_menu );
        res1_panel->appendChildWidget(res1_type_selector);
        connect(res1_type_selector,AParameters->getItem(PAR_RES1_TYPE));

        // inputs

        sa_tyr_SmallKnobWidget* res1_in_o1 = new sa_tyr_SmallKnobWidget( MIP_DRect(10+10,HH+310+60+10,27,45),"O1");
        res1_panel->appendChildWidget(res1_in_o1);
        connect(res1_in_o1,AParameters->getItem(PAR_RES1_IN_O1));

        sa_tyr_SmallKnobWidget* res1_in_o2 = new sa_tyr_SmallKnobWidget( MIP_DRect(40+10,HH+310+60+10,27,45),"O2");
        res1_panel->appendChildWidget(res1_in_o2);
        connect(res1_in_o2,AParameters->getItem(PAR_RES1_IN_O2));

        sa_tyr_SmallKnobWidget* res1_in_r1 = new sa_tyr_SmallKnobWidget( MIP_DRect(70+10,HH+310+60+10,27,45),"R1");
        res1_panel->appendChildWidget(res1_in_r1);
        connect(res1_in_r1,AParameters->getItem(PAR_RES1_IN_R1));

        sa_tyr_SmallKnobWidget* res1_in_r2 = new sa_tyr_SmallKnobWidget( MIP_DRect(100+10,HH+310+60+10,27,45),"R2");
        res1_panel->appendChildWidget(res1_in_r2);
        connect(res1_in_r2,AParameters->getItem(PAR_RES1_IN_R2));

        sa_tyr_SmallKnobWidget* res1_in_n = new sa_tyr_SmallKnobWidget( MIP_DRect(130+10,HH+310+60+10,27,45),"N");
        res1_panel->appendChildWidget(res1_in_n);
        connect(res1_in_n,AParameters->getItem(PAR_RES1_IN_N));

        sa_tyr_SmallKnobWidget* res1_in_a = new sa_tyr_SmallKnobWidget( MIP_DRect(160+10,HH+310+60+10,27,45),"A");
        ...
        sa_tyr_BigKnobWidget* res1_nshape_knob = new sa_tyr_BigKnobWidget( MIP_DRect(10+10,HH+310+110+10,50,82),"Shape");
        res1_panel->appendChildWidget(res1_nshape_knob);
        connect(res1_nshape_knob,AParameters->getItem(PAR_RES1_SHAPE));

        // fb

        sa_tyr_BigKnobWidget* res1_fb_knob = new sa_tyr_BigKnobWidget( MIP_DRect(70+10,HH+310+110+10,50,82),"FB");
        res1_panel->appendChildWidget(res1_fb_knob);
        connect(res1_fb_knob,AParameters->getItem(PAR_RES1_FB));

        // damp

        sa_tyr_BigKnobWidget* res1_damp_knob = new sa_tyr_BigKnobWidget( MIP_DRect(130+10,HH+310+110+10,50,82),"Damp");
        res1_panel->appendChildWidget(res1_damp_knob);
        connect(res1_damp_knob,AParameters->getItem(PAR_RES1_DAMP));

        // rough

        sa_tyr_BigKnobWidget* res1_rough_knob = new sa_tyr_BigKnobWidget( MIP_DRect(190+10,HH+310+110+10,50,82),"Rough",0.0,true);
        ...
        MIP_SliderWidget* res1_speed_slider = new MIP_SliderWidget( MIP_DRect(10+10,HH+310+200+10,240,20),"speed" );
        ...
        sa_tyr_DragValueWidget* res1_cent_slider = new sa_tyr_DragValueWidget( MIP_DRect(178+10,HH+310+230+10,72,20),"Cent",0.0,true,0.0,0.1);
...
// ----- osc2
      ...
      sa_tyr_SectionPanelWidget* osc2_panel = new sa_tyr_SectionPanelWidget(MIP_DRect(280,HH+10,260,300), "OSC2", 20 );
      MEditorPanel->appendChildWidget(osc2_panel);

        // type

        sa_tyr_SelectorWidget* osc2_type_selector = new sa_tyr_SelectorWidget( MIP_DRect(280+10,HH+30+10,240,20),"Osc Type",osc_type_menu );
        osc2_panel->appendChildWidget(osc2_type_selector);
        connect(osc2_type_selector,AParameters->getItem(PAR_OSC2_TYPE));

        // shape

        sa_tyr_BigKnobWidget* osc2_shape_knob = new sa_tyr_BigKnobWidget( MIP_DRect(280+10,HH+60,50,82),"Shape");
        osc2_panel->appendChildWidget(osc2_shape_knob);
        connect(osc2_shape_knob,AParameters->getItem(PAR_OSC2_SHAPE));

        // width

        sa_tyr_BigKnobWidget* osc2_width_knob = new sa_tyr_BigKnobWidget( MIP_DRect(280+70,HH+60,50,82),"Width",0.0,true);
        ...
        sa_tyr_DragValueWidget* osc2_cent_slider = new sa_tyr_DragValueWidget( MIP_DRect(280+178,HH+150,72,20),"Cent",0.0,true,0.0,0.1);
        osc2_panel->appendChildWidget(osc2_cent_slider);
        connect(osc2_cent_slider,AParameters->getItem(PAR_OSC2_CENT));

        // inputs

        sa_tyr_SmallKnobWidget* osc2_in_o1 = new sa_tyr_SmallKnobWidget( MIP_DRect(280+10,HH+180,27,45),"O1");
        osc2_panel->appendChildWidget(osc2_in_o1);
        connect(osc2_in_o1,AParameters->getItem(PAR_OSC2_IN_O1));

        sa_tyr_SmallKnobWidget* osc2_in_o2 = new sa_tyr_SmallKnobWidget( MIP_DRect(280+40,HH+180,27,45),"O2");
        osc2_panel->appendChildWidget(osc2_in_o2);
        connect(osc2_in_o2,AParameters->getItem(PAR_OSC2_IN_O2));

        sa_tyr_SmallKnobWidget* osc2_in_r1 = new sa_tyr_SmallKnobWidget( MIP_DRect(280+70,HH+180,27,45),"R1");
        osc2_panel->appendChildWidget(osc2_in_r1);
        connect(osc2_in_r1,AParameters->getItem(PAR_OSC2_IN_R1));

        sa_tyr_SmallKnobWidget* osc2_in_r2 = new sa_tyr_SmallKnobWidget( MIP_DRect(280+100,HH+180,27,45),"R2");
        osc2_panel->appendChildWidget(osc2_in_r2);
        connect(osc2_in_r2,AParameters->getItem(PAR_OSC2_IN_R2));

        sa_tyr_SmallKnobWidget* osc2_in_n = new sa_tyr_SmallKnobWidget( MIP_DRect(280+130,HH+180,27,45),"N");
        osc2_panel->appendChildWidget(osc2_in_n);
        connect(osc2_in_n,AParameters->getItem(PAR_OSC2_IN_N));

        sa_tyr_SmallKnobWidget* osc2_in_a = new sa_tyr_SmallKnobWidget( MIP_DRect(280+160,HH+180,27,45),"A");
        ...
        sa_tyr_SelectorWidget* osc2_phase_shaper_selector = new sa_tyr_SelectorWidget( MIP_DRect(280+10,HH+240,115,20),"Phase Shp",phase_shaper_type_menu );
        ...
        sa_tyr_SelectorWidget* osc2_wave_shaper_selector = new sa_tyr_SelectorWidget( MIP_DRect(280+10,HH+270,115,20),"Wave Shp",wave_shaper_type_menu );
...
// ----- res2 -----
      ...
      sa_tyr_SectionPanelWidget* res2_panel = new sa_tyr_SectionPanelWidget(MIP_DRect(280,HH+320,260,260), "RES2", 20 );
      MEditorPanel->appendChildWidget(res2_panel);

        // type

        sa_tyr_SelectorWidget* res2_type_selector = new sa_tyr_SelectorWidget( MIP_DRect(280+10,HH+310+30+10,230,20),"Res Type",res_type_menu );
        res2_panel->appendChildWidget(res2_type_selector);
        connect(res2_type_selector,AParameters->getItem(PAR_RES2_TYPE));

        // inputs

        sa_tyr_SmallKnobWidget* res2_in_o1 = new sa_tyr_SmallKnobWidget( MIP_DRect(280+10,HH+310+60+10,27,45),"O1");
        res2_panel->appendChildWidget(res2_in_o1);
        connect(res2_in_o1,AParameters->getItem(PAR_RES2_IN_O1));

        sa_tyr_SmallKnobWidget* res2_in_o2 = new sa_tyr_SmallKnobWidget( MIP_DRect(280+40,HH+310+60+10,27,45),"O2");
        res2_panel->appendChildWidget(res2_in_o2);
        connect(res2_in_o2,AParameters->getItem(PAR_RES2_IN_O2));

        sa_tyr_SmallKnobWidget* res2_in_r1 = new sa_tyr_SmallKnobWidget( MIP_DRect(280+70,HH+310+60+10,27,45),"R1");
        res2_panel->appendChildWidget(res2_in_r1);
        connect(res2_in_r1,AParameters->getItem(PAR_RES2_IN_R1));

        sa_tyr_SmallKnobWidget* res2_in_r2 = new sa_tyr_SmallKnobWidget( MIP_DRect(280+100,HH+310+60+10,27,45),"R2");
        res2_panel->appendChildWidget(res2_in_r2);
        connect(res2_in_r2,AParameters->getItem(PAR_RES2_IN_R2));

        sa_tyr_SmallKnobWidget* res2_in_n = new sa_tyr_SmallKnobWidget( MIP_DRect(280+130,HH+310+60+10,27,45),"N");
        res2_panel->appendChildWidget(res2_in_n);
        connect(res2_in_n,AParameters->getItem(PAR_RES2_IN_N));

        sa_tyr_SmallKnobWidget* res2_in_a = new sa_tyr_SmallKnobWidget( MIP_DRect(280+160,HH+310+60+10,27,45),"A");
        ...
        sa_tyr_BigKnobWidget* res2_nshape_knob = new sa_tyr_BigKnobWidget( MIP_DRect(280+10,HH+310+110+10,50,82),"Shape");
        res2_panel->appendChildWidget(res2_nshape_knob);
        connect(res2_nshape_knob,AParameters->getItem(PAR_RES2_SHAPE));

        // fb

        sa_tyr_BigKnobWidget* res2_fb_knob = new sa_tyr_BigKnobWidget( MIP_DRect(280+70,HH+310+110+10,50,82),"FB");
        res2_panel->appendChildWidget(res2_fb_knob);
        connect(res2_fb_knob,AParameters->getItem(PAR_RES2_FB));

        // damp

        sa_tyr_BigKnobWidget* res2_damp_knob = new sa_tyr_BigKnobWidget( MIP_DRect(280+130,HH+310+110+10,50,82),"Damp");
        res2_panel->appendChildWidget(res2_damp_knob);
        connect(res2_damp_knob,AParameters->getItem(PAR_RES2_DAMP));

        // rough

        sa_tyr_BigKnobWidget* res2_rough_knob = new sa_tyr_BigKnobWidget( MIP_DRect(280+190,HH+310+110+10,50,82),"Rough",0.0,true);
        ...
        sa_tyr_SliderWidget* res2_speed_slider = new sa_tyr_SliderWidget( MIP_DRect(280+10,HH+310+200+10,240,20),"speed" );
        ...
        sa_tyr_DragValueWidget* res2_cent_slider = new sa_tyr_DragValueWidget( MIP_DRect(280+178,HH+310+230+10,72,20),"Cent",0.0,true,0.0,0.1);
...
//
      ...
      sa_tyr_SectionPanelWidget* voice2_panel = new sa_tyr_SectionPanelWidget(MIP_DRect(550,HH+10,276,75+30), "Voices", 20 );
      MEditorPanel->appendChildWidget(voice2_panel);

        // voices

        MVoiceWidget = new sa_tyr_VoiceWidget( MIP_DRect(550+10,HH+30+10,256,8) );
        voice2_panel->appendChildWidget(MVoiceWidget);

        MPlayingVoicesWidget = new MIP_ValueWidget( MIP_DRect(550+10,HH+45+10,150,15), "Playing:",0 );
        ...
        MReleasedVoicesWidget = new MIP_ValueWidget( MIP_DRect(550+10,HH+60+10,150,15), "Released:",0 );
        ...
        MTotalVoicesWidget = new MIP_ValueWidget( MIP_DRect(550+10,HH+75+10,150,15), "Total:",0 );
      ...
      sa_tyr_SectionPanelWidget* flt1_panel = new sa_tyr_SectionPanelWidget(MIP_DRect(550,HH+125,276,145), "Filter", 20 );
      MEditorPanel->appendChildWidget(flt1_panel);

        // type

        sa_tyr_SelectorWidget* flt1_type_selector = new sa_tyr_SelectorWidget( MIP_DRect(550+10,HH+125+30,256,20),"Flt Type",flt_type_menu );
        flt1_panel->appendChildWidget(flt1_type_selector);
        connect(flt1_type_selector,AParameters->getItem(PAR_FLT1_TYPE));

        // freq

        sa_tyr_BigKnobWidget* flt1_freq_knob = new sa_tyr_BigKnobWidget( MIP_DRect(550+10,HH+125+60,50,82),"Freq");
        flt1_panel->appendChildWidget(flt1_freq_knob);
        connect(flt1_freq_knob,AParameters->getItem(PAR_FLT1_FREQ));

        // res

        sa_tyr_BigKnobWidget* flt1_res_knob = new sa_tyr_BigKnobWidget( MIP_DRect(550+70,HH+125+60,50,82),"Res");
        flt1_panel->appendChildWidget(flt1_res_knob);
        connect(flt1_res_knob,AParameters->getItem(PAR_FLT1_RES));

      // ----- env1 -----

      sa_tyr_SectionPanelWidget* env1_panel = new sa_tyr_SectionPanelWidget(MIP_DRect(550,HH+280,276,115), "Env", 20 );
      MEditorPanel->appendChildWidget(env1_panel);

        // att

        sa_tyr_BigKnobWidget* env1_att_knob = new sa_tyr_BigKnobWidget( MIP_DRect(550+10,HH+280+30,50,82),"Att");
        env1_panel->appendChildWidget(env1_att_knob);
        connect(env1_att_knob,AParameters->getItem(PAR_ENV1_ATT));

        // dec

        sa_tyr_BigKnobWidget* env1_dec_knob = new sa_tyr_BigKnobWidget( MIP_DRect(550+70,HH+280+30,50,82),"Dec");
        env1_panel->appendChildWidget(env1_dec_knob);
        connect(env1_dec_knob,AParameters->getItem(PAR_ENV1_DEC));

        // sus

        sa_tyr_BigKnobWidget* env1_sus_knob = new sa_tyr_BigKnobWidget( MIP_DRect(550+130,HH+280+30,50,82),"Sus");
        env1_panel->appendChildWidget(env1_sus_knob);
        connect(env1_sus_knob,AParameters->getItem(PAR_ENV1_SUS));

        // rel

        sa_tyr_BigKnobWidget* env1_rel_knob = new sa_tyr_BigKnobWidget( MIP_DRect(550+190,HH+280+30,50,82),"Rel");
        env1_panel->appendChildWidget(env1_rel_knob);
        connect(env1_rel_knob,AParameters->getItem(PAR_ENV1_REL));

      // ----- global -----

      sa_tyr_SectionPanelWidget* global_panel = new sa_tyr_SectionPanelWidget(MIP_DRect(550,HH+405,276,210), "Mix", 20 );
      MEditorPanel->appendChildWidget(global_panel);

        // osc1 out

        sa_tyr_BigKnobWidget* global_osc1_out_knob = new sa_tyr_BigKnobWidget( MIP_DRect(550+10,HH+405+30,50,82),"O1");
        global_panel->appendChildWidget(global_osc1_out_knob);
        connect(global_osc1_out_knob,AParameters->getItem(PAR_MASTER_OSC1_OUT));

        // osc2 out

        sa_tyr_BigKnobWidget* global_osc2_out_knob = new sa_tyr_BigKnobWidget( MIP_DRect(550+70,HH+405+30,50,82),"O2");
        global_panel->appendChildWidget(global_osc2_out_knob);
        connect(global_osc2_out_knob,AParameters->getItem(PAR_MASTER_OSC2_OUT));

        // res1 out

        sa_tyr_BigKnobWidget* global_res1_out_knob = new sa_tyr_BigKnobWidget( MIP_DRect(550+130,HH+405+30,50,82),"R1");
        global_panel->appendChildWidget(global_res1_out_knob);
        connect(global_res1_out_knob,AParameters->getItem(PAR_MASTER_RES1_OUT));

        // res2 out

        sa_tyr_BigKnobWidget* global_res2_out_knob = new sa_tyr_BigKnobWidget( MIP_DRect(550+190,HH+405+30,50,82),"R2");
        global_panel->appendChildWidget(global_res2_out_knob);
        connect(global_res2_out_knob,AParameters->getItem(PAR_MASTER_RES2_OUT));

        // vol

        sa_tyr_BigKnobWidget* global_vol_knob = new sa_tyr_BigKnobWidget( MIP_DRect(550+10,HH+405+120,50,82),"Vol");
        global_panel->appendChildWidget(global_vol_knob);
        connect(global_vol_knob,AParameters->getItem(PAR_MASTER_VOL));

        // pan

        sa_tyr_BigKnobWidget* global_pan_knob = new sa_tyr_BigKnobWidget( MIP_DRect(550+70,HH+405+120,50,82),"Pan",0.0,true);
