...
class MIP_SA_ScaleParameter
: public MIP_Parameter {

public:

  MIP_SA_ScaleParameter(const char* AName="", double AValue=0.0, double AMin=-1.0, double AMax=1.0)
...
//  // ----- fx filter
  ...
  /* PAR_PROB_SIZE_MIN_RANGE */     APlugin->appendParameter(new MIP_SA_ScaleParameter(     "Size Min Range",      -0.5,       -1, 1 ));
  /* PAR_PROB_SIZE_MAX_RANGE */     APlugin->appendParameter(new MIP_SA_ScaleParameter(     "Size Max Range",       0.5,         -1, 1 ));

  /* PAR_PROB_SIZE_PROB_LOOP */     APlugin->appendParameter(new MIP_SA_PercentParameter(     "Size Prob Loop",       0.25,       0, 1 ));
  /* PAR_PROB_SIZE_MIN_LOOP */      APlugin->appendParameter(new MIP_SA_ScaleParameter(     "Size Min Loop",       -0.5,       -1, 1 ));
  /* PAR_PROB_SIZE_MAX_LOOP */      APlugin->appendParameter(new MIP_SA_ScaleParameter(     "Size Max Loop",        0.5,       -1, 1 ));

  // ----- loop speed

  /* PAR_PROB_SPEED_PROB_RANGE */   APlugin->appendParameter(new MIP_SA_PercentParameter(     "Speed Prob Range",     0.25,       0, 1 ));
  /* PAR_PROB_SPEED_MIN_RANGE */    APlugin->appendParameter(new MIP_SA_ScaleParameter(     "Speed Min Range",     -0.5,       -1, 1 ));
  /* PAR_PROB_SPEED_MAX_RANGE */    APlugin->appendParameter(new MIP_SA_ScaleParameter(     "Speed Max Range",      0.5,       -1, 1 ));

  /* PAR_PROB_SPEED_PROB_LOOP */    APlugin->appendParameter(new MIP_SA_PercentParameter(     "Speed Prob Loop",      0.25,       0, 1 ));
  /* PAR_PROB_SPEED_MIN_LOOP */     APlugin->appendParameter(new MIP_SA_ScaleParameter(     "Speed Min Loop",      -0.5,       -1, 1 ));
  /* PAR_PROB_SPEED_MAX_LOOP */     APlugin->appendParameter(new MIP_SA_ScaleParameter(     "Speed Max Loop",       0.5,       -1, 1 ));

  // ----- loop offset

  /* PAR_PROB_OFFSET_PROB_RANGE */  APlugin->appendParameter(new MIP_SA_PercentParameter(     "Offset Prob Range",    0.25,       0, 1 ));
  /* PAR_PROB_OFFSET_MIN_RANGE */   APlugin->appendParameter(new MIP_SA_ScaleParameter(     "Offset Min Range",    -0.5,       -1, 1 ));
  /* PAR_PROB_OFFSET_MAX_RANGE */   APlugin->appendParameter(new MIP_SA_ScaleParameter(     "Offset Max Range",     0.5,       -1, 1 ));

  /* PAR_PROB_OFFSET_PROB_LOOP */   APlugin->appendParameter(new MIP_SA_PercentParameter(     "Offset Prob Loop",     0.25,       0, 1 ));
  /* PAR_PROB_OFFSET_MIN_LOOP */    APlugin->appendParameter(new MIP_SA_ScaleParameter(     "Offset Min Loop",     -0.5,       -1, 1 ));
  /* PAR_PROB_OFFSET_MAX_LOOP */    APlugin->appendParameter(new MIP_SA_ScaleParameter(     "Offset Max Loop",      0.5,       -1, 1 ));
  ...
  /* PAR_PROB_FX_MIN_RANGE */       APlugin->appendParameter(new MIP_SA_ScaleParameter(     "FX Min Range",        -0.5,       -1, 1 ));
  /* PAR_PROB_FX_MAX_RANGE */       APlugin->appendParameter(new MIP_SA_ScaleParameter(     "FX Max Range",         0.5,       -1, 1 ));

  /* PAR_PROB_FX_PROB_LOOP */       APlugin->appendParameter(new MIP_SA_PercentParameter(     "FX Prob Loop",         0.25,       0, 1 ));
  /* PAR_PROB_FX_MIN_LOOP */        APlugin->appendParameter(new MIP_SA_ScaleParameter(     "FX Min Loop",         -0.5,       -1, 1 ));
  /* PAR_PROB_FX_MAX_LOOP */        APlugin->appendParameter(new MIP_SA_ScaleParameter(     "FX Max Loop",          0.5,       -1, 1 ));
