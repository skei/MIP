...
//  },
  ...
  /* PAR_RANGE_PROB */ APlugin->appendParameter(new sa_botage_percent_parameter( "%", 0.25, 0, 1 ));
...
//  },
  ...
  /* PAR_LOOP_ENV_ATTACK */ APlugin->appendParameter(new MIP_Parameter( "ms", 1, 0,10 ));
...
//  },
  ...
  /* PAR_LOOP_ENV_DECAY */  APlugin->appendParameter(new MIP_Parameter( "ms", 9, 0,10 ));
...
//  },
  ...
  /* PAR_SLICE_ENV_ATTACK */  APlugin->appendParameter(new MIP_Parameter( "%", 0,   0, 100 ));
...
//  },
  ...
  /* PAR_SLICE_ENV_DECAY */   APlugin->appendParameter(new MIP_Parameter( "%", 100, 0, 100 ));
...
//  },
  ...
  /* PAR_PROB_SIZE_PROB_RANGE */ APlugin->appendParameter(new sa_botage_percent_parameter( "%", 0,  0, 1 ));
...
//  },
  ...
  /* PAR_PROB_SIZE_MIN_RANGE */ APlugin->appendParameter(new sa_botage_range_parameter(   "%", 0, -1, 1 ));
...
//  },
  ...
  /* PAR_PROB_SIZE_MAX_RANGE */ APlugin->appendParameter(new sa_botage_range_parameter(   "%", 0, -1, 1 ));
