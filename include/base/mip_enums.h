...
enum MIP_EWidgetUpdateModes {
  MIP_UPDATE_VALUE = 0,
};

enum MIP_EWidgetRedrawModes {
  MIP_REDRAW_FULL = 0,
};

enum MIP_EWidgetKeyCaptureModes {
  MIP_KEY_CAPTURE_OFF = 0,
  MIP_KEY_CAPTURE_ON  = 1,
};

enum MIP_EWidgetModalModes {
  MIP_MODAL_OFF = 0,
  MIP_MODAL_ON  = 1,
};
...
enum MIP_EVoiceEventMode {
  MIP_VOICE_EVENT_MODE_BLOCK = 0,
  MIP_VOICE_EVENT_MODE_INTERLEAVED,
  MIP_VOICE_EVENT_MODE_QUANTIZED
};
