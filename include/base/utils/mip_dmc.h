...
//------------------------------
  ...
  int             threshold = 0;
  int             bigthresh = 0;
  mip_dmc_node   *P = nullptr;
  mip_dmc_node   *N = nullptr;
  mip_dmc_node   nodes[256][256] = {};
  mip_dmc_node   *nodebuf = nullptr;
  mip_dmc_node   *nodemaxp = nullptr;
  mip_dmc_node   *nodesptr = nullptr;
...
//------------------------------
  ...
  void p_init(int memsize) {
    ...
    nodebuf = (mip_dmc_node *)malloc(memsize);
