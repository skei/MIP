...
//------------------------------
  ...
  clap_host_context_menu_t*       MContextMenu        = nullptr;
  ...
  clap_host_remote_controls_t*    MRemoteControls     = nullptr;
  clap_host_resource_directory_t* MResourceDirectory  = nullptr;
  ...
  clap_host_triggers_t*           MTriggers           = nullptr;
...
//------------------------------
  ...
  void initExtensions() {
    ...
    MContextMenu        = (clap_host_context_menu_t*)MHost->get_extension(MHost,CLAP_EXT_CONTEXT_MENU);
    ...
    MRemoteControls     = (clap_host_remote_controls_t*)MHost->get_extension(MHost,CLAP_EXT_REMOTE_CONTROLS);
    MResourceDirectory  = (clap_host_resource_directory_t*)MHost->get_extension(MHost,CLAP_EXT_RESOURCE_DIRECTORY);
    ...
    MTriggers           = (clap_host_triggers_t*)MHost->get_extension(MHost,CLAP_EXT_TRIGGERS);
